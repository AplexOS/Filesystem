...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.24.1/arm-linux',
    archname => 'arm-linux',
    cc => '/home/ECM_5412/filesytem_buildroot/buildroot-2017.02.5/output/host/usr/bin/arm-none-linux-gnueabi-gcc',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    dlsrc => 'dl_dlopen.xs',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl5/site_perl/5.24.1/arm-linux',
