...
class dtu_sqlite():
    ...
    def create_tables(self, database_name):
        ...
        try :
            ...
            self.index_id[self.database_name1] = self.search_last_data(self.database_name1)
            self.index_id[self.database_name2] = self.search_last_data(self.database_name2)
