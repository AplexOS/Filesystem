...
class mqtt_operation(threading.Thread):
    def __init__(self, name):
        ...
        self.is_work_filter = 0
        self.is_notwork_filter = 0
        self.last_is_work_value = 0

        self.count_is_work_flag = 4
    ...
    def compile_message(self, message):
        ...
        '''
        if (is_work):
            self.is_work_filter = self.is_work_filter + 1
            self.is_notwork_filter = 0

            if (self.is_work_filter > self.count_is_work_flag):
                message["data"]["is_work"] = 1
            else :
                message["data"]["is_work"] = self.last_is_work_value
        else :
            self.is_notwork_filter = self.is_notwork_filter + 1
            self.is_work_filter = 0

            if (self.is_notwork_filter > self.count_is_work_flag):
                message["data"]["is_work"] = 0
            else :
                message["data"]["is_work"] = self.last_is_work_value
        self.last_is_work_value = message["data"]["is_work"]
        '''
        message["data"]["is_work"] = is_work
    ...
    def send_message_to_tractors(self):
        ...
        while True :
            ...
            if (self.tractor_message_pub["data"]["is_work"] == 1):
                ...
                del self.tractor_message_pub["data"]["contentSource"]
                cur_qos = 0
                continue_flag = 0
                ...
                if(not continue_flag) :
                    ...
                    self.tractor_message_pub["data"]["contentSource"] = config.contentSource
                    cur_qos = 2
    ...
    def send_message_to_server(self):
        ...
        while True :
            ...
            if (self.server_message_pub["data"]["is_work"] == 1):
                ...
                del self.server_message_pub["data"]["contentSource"]
                cur_qos = 0
                ...
                if (last_is_work_status == 1) :
                    ...
                    self.server_message_pub["data"]["contentSource"] = config.contentSource
                    cur_qos = 2
                else :
                    del self.server_message_pub["data"]["content"]
                    del self.server_message_pub["data"]["contentSource"]
...
if __name__ == "__main__" :
    os.system("../update/update_check.sh")
